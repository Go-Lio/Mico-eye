...
#define AI_TOOLS_DATE_TIME   "Sun Oct 16 01:15:11 2022"
...
static ai_ptr g_network_weights_map[106] = AI_C_ARRAY_INIT;
...
/* Array#16 */
AI_ARRAY_OBJ_DECLARE(
  pad_14_output_array, AI_ARRAY_FORMAT_S8,
...
/* Array#30 */
AI_ARRAY_OBJ_DECLARE(
  pad_26_output_array, AI_ARRAY_FORMAT_S8,
...
/* Array#279 */
AI_ARRAY_OBJ_DECLARE(
  dense_69_scratch0_array, AI_ARRAY_FORMAT_S16,
  NULL, NULL, 1280, AI_STATIC)
...
/* Int quant #16 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(pad_14_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0235294122248888f),
    AI_PACK_INTQ_ZP(-128)))
...
/* Int quant #30 */
AI_INTQ_INFO_LIST_OBJ_DECLARE(pad_26_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.0235294122248888f),
    AI_PACK_INTQ_ZP(-128)))
...
/* Tensor #16 */
AI_TENSOR_OBJ_DECLARE(
  pad_14_output, AI_STATIC,
  16, 0x1,
  AI_SHAPE_INIT(4, 1, 48, 33, 33), AI_STRIDE_INIT(4, 1, 1, 48, 1584),
  1, &pad_14_output_array, &pad_14_output_array_intq)
...
/* Tensor #30 */
AI_TENSOR_OBJ_DECLARE(
  pad_26_output, AI_STATIC,
  30, 0x1,
  AI_SHAPE_INIT(4, 1, 96, 17, 17), AI_STRIDE_INIT(4, 1, 1, 96, 1632),
  1, &pad_26_output_array, &pad_26_output_array_intq)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  130, 0x1,
  AI_SHAPE_INIT(4, 144, 3, 3, 1), AI_STRIDE_INIT(4, 1, 1, 144, 432),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  172, 0x1,
  AI_SHAPE_INIT(4, 336, 3, 3, 1), AI_STRIDE_INIT(4, 1, 1, 336, 1008),
...
/* Tensor #279 */
AI_TENSOR_OBJ_DECLARE(
  dense_69_scratch0, AI_STATIC,
  279, 0x0,
  AI_SHAPE_INIT(4, 1, 1280, 1, 1), AI_STRIDE_INIT(4, 2, 2, 2560, 2560),
  1, &dense_69_scratch0_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &dense_69_scratch0)
)
...
AI_STATIC_CONST ai_i8 pad_53_value_data[] = { -128 };
AI_ARRAY_OBJ_DECLARE(
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &pad_26_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_27_output),
...
AI_STATIC_CONST ai_i8 pad_26_value_data[] = { -128 };
AI_ARRAY_OBJ_DECLARE(
    pad_26_value, AI_ARRAY_FORMAT_S8,
    pad_26_value_data, pad_26_value_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pad_26_chain, AI_STATIC_CONST, 4,
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &pad_14_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &conv2d_15_output),
...
AI_STATIC_CONST ai_i8 pad_14_value_data[] = { -128 };
AI_ARRAY_OBJ_DECLARE(
    pad_14_value, AI_ARRAY_FORMAT_S8,
    pad_14_value_data, pad_14_value_data, 1, AI_STATIC_CONST)
AI_TENSOR_CHAIN_OBJ_DECLARE(
  pad_14_chain, AI_STATIC_CONST, 4,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_1_output_array.data = AI_PTR(g_network_activations_map[0] + 6876);
    input_1_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6876);
    
    conversion_0_output_array.data = AI_PTR(g_network_activations_map[0] + 56028);
    conversion_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 56028);
    
    conv2d_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 105184);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 105184);
    
    conv2d_2_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 38608);
    conv2d_2_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 38608);
    
    conv2d_2_output_array.data = AI_PTR(g_network_activations_map[0] + 38608);
    conv2d_2_output_array.data_start = AI_PTR(g_network_activations_map[0] + 38608);
    
    conv2d_3_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 34448);
    conv2d_3_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 34448);
    
    conv2d_3_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 105784);
    conv2d_3_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 105784);
    
    conv2d_3_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 33424);
    conv2d_3_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 33424);
    
    conv2d_3_output_array.data = AI_PTR(g_network_activations_map[0] + 33424);
    conv2d_3_output_array.data_start = AI_PTR(g_network_activations_map[0] + 33424);
    
    conv2d_4_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 33280);
    conv2d_4_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 33280);
    ...
    conv2d_5_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 33280);
    conv2d_5_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 33280);
    
    conv2d_5_output_array.data = AI_PTR(g_network_activations_map[0] + 33280);
    conv2d_5_output_array.data_start = AI_PTR(g_network_activations_map[0] + 33280);
    
    pad_6_output_array.data = AI_PTR(g_network_activations_map[0] + 27088);
    pad_6_output_array.data_start = AI_PTR(g_network_activations_map[0] + 27088);
    ...
    conv2d_7_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 25552);
    conv2d_7_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 25552);
    
    conv2d_7_output_array.data = AI_PTR(g_network_activations_map[0] + 25552);
    conv2d_7_output_array.data_start = AI_PTR(g_network_activations_map[0] + 25552);
    ...
    conv2d_9_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 8976);
    conv2d_9_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 8976);
    
    conv2d_9_output_array.data = AI_PTR(g_network_activations_map[0] + 58128);
    conv2d_9_output_array.data_start = AI_PTR(g_network_activations_map[0] + 58128);
    
    conv2d_10_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 107280);
    conv2d_10_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 107280);
    
    conv2d_10_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 8464);
    conv2d_10_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 8464);
    
    conv2d_10_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 10244);
    conv2d_10_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 10244);
    
    conv2d_10_output_array.data = AI_PTR(g_network_activations_map[0] + 162768);
    conv2d_10_output_array.data_start = AI_PTR(g_network_activations_map[0] + 162768);
    ...
    conv2d_11_output_array.data = AI_PTR(g_network_activations_map[0] + 8464);
    conv2d_11_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8464);
    
    eltwise_12_output_array.data = AI_PTR(g_network_activations_map[0] + 16656);
    eltwise_12_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16656);
    ...
    conv2d_13_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 24848);
    conv2d_13_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 24848);
    
    conv2d_13_output_array.data = AI_PTR(g_network_activations_map[0] + 74000);
    conv2d_13_output_array.data_start = AI_PTR(g_network_activations_map[0] + 74000);
    
    pad_14_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    pad_14_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv2d_15_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 52272);
    conv2d_15_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 52272);
    
    conv2d_15_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 54052);
    conv2d_15_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 54052);
    
    conv2d_15_output_array.data = AI_PTR(g_network_activations_map[0] + 66340);
    conv2d_15_output_array.data_start = AI_PTR(g_network_activations_map[0] + 66340);
    ...
    conv2d_17_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 5472);
    conv2d_17_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 5472);
    
    conv2d_17_output_array.data = AI_PTR(g_network_activations_map[0] + 30048);
    conv2d_17_output_array.data_start = AI_PTR(g_network_activations_map[0] + 30048);
    
    conv2d_18_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 54624);
    conv2d_18_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 54624);
    ...
    conv2d_18_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 8004);
    conv2d_18_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 8004);
    
    conv2d_18_output_array.data = AI_PTR(g_network_activations_map[0] + 85728);
    conv2d_18_output_array.data_start = AI_PTR(g_network_activations_map[0] + 85728);
    
    conv2d_19_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 4448);
    conv2d_19_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 4448);
    
    conv2d_19_output_array.data = AI_PTR(g_network_activations_map[0] + 4992);
    conv2d_19_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4992);
    
    eltwise_20_output_array.data = AI_PTR(g_network_activations_map[0] + 9088);
    eltwise_20_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9088);
    ...
    conv2d_22_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 62336);
    conv2d_22_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 62336);
    ...
    conv2d_22_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 13184);
    conv2d_22_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 13184);
    
    conv2d_22_output_array.data = AI_PTR(g_network_activations_map[0] + 37760);
    conv2d_22_output_array.data_start = AI_PTR(g_network_activations_map[0] + 37760);
    ...
    eltwise_24_output_array.data = AI_PTR(g_network_activations_map[0] + 4640);
    eltwise_24_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4640);
    ...
    conv2d_25_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 8736);
    conv2d_25_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 8736);
    
    conv2d_25_output_array.data = AI_PTR(g_network_activations_map[0] + 33312);
    conv2d_25_output_array.data_start = AI_PTR(g_network_activations_map[0] + 33312);
    
    pad_26_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    pad_26_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv2d_27_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 27744);
    conv2d_27_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 27744);
    
    conv2d_27_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 31300);
    conv2d_27_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 31300);
    
    conv2d_27_output_array.data = AI_PTR(g_network_activations_map[0] + 37444);
    conv2d_27_output_array.data_start = AI_PTR(g_network_activations_map[0] + 37444);
    ...
    conv2d_29_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 3696);
    conv2d_29_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 3696);
    
    conv2d_29_output_array.data = AI_PTR(g_network_activations_map[0] + 12912);
    conv2d_29_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12912);
    
    conv2d_30_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 22128);
    conv2d_30_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 22128);
    ...
    conv2d_30_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 7492);
    conv2d_30_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 7492);
    
    conv2d_30_output_array.data = AI_PTR(g_network_activations_map[0] + 36528);
    conv2d_30_output_array.data_start = AI_PTR(g_network_activations_map[0] + 36528);
    
    conv2d_31_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 2160);
    conv2d_31_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 2160);
    
    conv2d_31_output_array.data = AI_PTR(g_network_activations_map[0] + 2976);
    conv2d_31_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2976);
    
    eltwise_32_output_array.data = AI_PTR(g_network_activations_map[0] + 4512);
    eltwise_32_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4512);
    ...
    conv2d_33_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 6048);
    conv2d_33_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 6048);
    
    conv2d_33_output_array.data = AI_PTR(g_network_activations_map[0] + 15264);
    conv2d_33_output_array.data_start = AI_PTR(g_network_activations_map[0] + 15264);
    
    conv2d_34_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 24480);
    conv2d_34_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24480);
    
    conv2d_34_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 6048);
    conv2d_34_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 6048);
    
    conv2d_34_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 11380);
    conv2d_34_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 11380);
    
    conv2d_34_output_array.data = AI_PTR(g_network_activations_map[0] + 38880);
    conv2d_34_output_array.data_start = AI_PTR(g_network_activations_map[0] + 38880);
    ...
    eltwise_36_output_array.data = AI_PTR(g_network_activations_map[0] + 2352);
    eltwise_36_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2352);
    ...
    conv2d_37_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 3888);
    conv2d_37_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 3888);
    
    conv2d_37_output_array.data = AI_PTR(g_network_activations_map[0] + 13104);
    conv2d_37_output_array.data_start = AI_PTR(g_network_activations_map[0] + 13104);
    
    conv2d_38_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 22320);
    conv2d_38_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 22320);
    
    conv2d_38_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 3888);
    conv2d_38_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 3888);
    
    conv2d_38_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 9220);
    conv2d_38_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 9220);
    
    conv2d_38_output_array.data = AI_PTR(g_network_activations_map[0] + 36720);
    conv2d_38_output_array.data_start = AI_PTR(g_network_activations_map[0] + 36720);
    ...
    eltwise_40_output_array.data = AI_PTR(g_network_activations_map[0] + 3888);
    eltwise_40_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3888);
    ...
    conv2d_41_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 5424);
    conv2d_41_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 5424);
    
    conv2d_41_output_array.data = AI_PTR(g_network_activations_map[0] + 14640);
    conv2d_41_output_array.data_start = AI_PTR(g_network_activations_map[0] + 14640);
    ...
    conv2d_42_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 14400);
    conv2d_42_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 14400);
    
    conv2d_42_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 19732);
    conv2d_42_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 19732);
    
    conv2d_42_output_array.data = AI_PTR(g_network_activations_map[0] + 28948);
    conv2d_42_output_array.data_start = AI_PTR(g_network_activations_map[0] + 28948);
    ...
    conv2d_44_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 4992);
    conv2d_44_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 4992);
    
    conv2d_44_output_array.data = AI_PTR(g_network_activations_map[0] + 17280);
    conv2d_44_output_array.data_start = AI_PTR(g_network_activations_map[0] + 17280);
    
    conv2d_45_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 29568);
    conv2d_45_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 29568);
    ...
    conv2d_45_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 10052);
    conv2d_45_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 10052);
    
    conv2d_45_output_array.data = AI_PTR(g_network_activations_map[0] + 48768);
    conv2d_45_output_array.data_start = AI_PTR(g_network_activations_map[0] + 48768);
    
    conv2d_46_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 2944);
    conv2d_46_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 2944);
    
    conv2d_46_output_array.data = AI_PTR(g_network_activations_map[0] + 4032);
    conv2d_46_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4032);
    
    eltwise_47_output_array.data = AI_PTR(g_network_activations_map[0] + 6080);
    eltwise_47_output_array.data_start = AI_PTR(g_network_activations_map[0] + 6080);
    ...
    conv2d_48_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 8128);
    conv2d_48_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 8128);
    
    conv2d_48_output_array.data = AI_PTR(g_network_activations_map[0] + 20416);
    conv2d_48_output_array.data_start = AI_PTR(g_network_activations_map[0] + 20416);
    
    conv2d_49_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 32704);
    conv2d_49_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32704);
    
    conv2d_49_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 8128);
    conv2d_49_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 8128);
    
    conv2d_49_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 15236);
    conv2d_49_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 15236);
    
    conv2d_49_output_array.data = AI_PTR(g_network_activations_map[0] + 51904);
    conv2d_49_output_array.data_start = AI_PTR(g_network_activations_map[0] + 51904);
    ...
    eltwise_51_output_array.data = AI_PTR(g_network_activations_map[0] + 3136);
    eltwise_51_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3136);
    ...
    conv2d_52_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 5184);
    conv2d_52_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 5184);
    
    conv2d_52_output_array.data = AI_PTR(g_network_activations_map[0] + 17472);
    conv2d_52_output_array.data_start = AI_PTR(g_network_activations_map[0] + 17472);
    ...
    conv2d_54_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 15552);
    conv2d_54_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 15552);
    
    conv2d_54_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 22660);
    conv2d_54_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 22660);
    
    conv2d_54_output_array.data = AI_PTR(g_network_activations_map[0] + 25732);
    conv2d_54_output_array.data_start = AI_PTR(g_network_activations_map[0] + 25732);
    ...
    conv2d_56_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 5808);
    conv2d_56_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 5808);
    
    conv2d_56_output_array.data = AI_PTR(g_network_activations_map[0] + 11184);
    conv2d_56_output_array.data_start = AI_PTR(g_network_activations_map[0] + 11184);
    
    conv2d_57_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 16560);
    conv2d_57_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 16560);
    ...
    conv2d_57_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 28656);
    conv2d_57_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 28656);
    
    conv2d_57_output_array.data = AI_PTR(g_network_activations_map[0] + 34032);
    conv2d_57_output_array.data_start = AI_PTR(g_network_activations_map[0] + 34032);
    
    conv2d_58_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 2224);
    conv2d_58_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 2224);
    
    conv2d_58_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    conv2d_58_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    eltwise_59_output_array.data = AI_PTR(g_network_activations_map[0] + 2224);
    eltwise_59_output_array.data_start = AI_PTR(g_network_activations_map[0] + 2224);
    ...
    conv2d_60_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 6704);
    conv2d_60_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 6704);
    
    conv2d_60_output_array.data = AI_PTR(g_network_activations_map[0] + 12080);
    conv2d_60_output_array.data_start = AI_PTR(g_network_activations_map[0] + 12080);
    
    conv2d_61_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 17456);
    conv2d_61_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 17456);
    
    conv2d_61_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 3120);
    conv2d_61_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 3120);
    
    conv2d_61_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 29552);
    conv2d_61_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 29552);
    
    conv2d_61_output_array.data = AI_PTR(g_network_activations_map[0] + 34928);
    conv2d_61_output_array.data_start = AI_PTR(g_network_activations_map[0] + 34928);
    ...
    conv2d_62_output_array.data = AI_PTR(g_network_activations_map[0] + 3120);
    conv2d_62_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3120);
    
    eltwise_63_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    eltwise_63_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    conv2d_64_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 896);
    conv2d_64_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 896);
    
    conv2d_64_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 4480);
    conv2d_64_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 4480);
    
    conv2d_64_output_array.data = AI_PTR(g_network_activations_map[0] + 9856);
    conv2d_64_output_array.data_start = AI_PTR(g_network_activations_map[0] + 9856);
    
    conv2d_65_pad_before_output_array.data = AI_PTR(g_network_activations_map[0] + 15232);
    conv2d_65_pad_before_output_array.data_start = AI_PTR(g_network_activations_map[0] + 15232);
    ...
    conv2d_65_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 27328);
    conv2d_65_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 27328);
    
    conv2d_65_output_array.data = AI_PTR(g_network_activations_map[0] + 32704);
    conv2d_65_output_array.data_start = AI_PTR(g_network_activations_map[0] + 32704);
    ...
    conv2d_67_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 4256);
    conv2d_67_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 4256);
    
    conv2d_67_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 17504);
    conv2d_67_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 17504);
    
    conv2d_67_output_array.data = AI_PTR(g_network_activations_map[0] + 37984);
    conv2d_67_output_array.data_start = AI_PTR(g_network_activations_map[0] + 37984);
    ...
    dense_69_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 1280);
    dense_69_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 1280);
    
    dense_69_output_array.data = AI_PTR(g_network_activations_map[0] + 3840);
    dense_69_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3840);
    
    dense_69_0_conversion_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    dense_69_0_conversion_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    
    nl_70_output_array.data = AI_PTR(g_network_activations_map[0] + 8);
    nl_70_output_array.data_start = AI_PTR(g_network_activations_map[0] + 8);
    
    nl_70_0_conversion_output_array.data = AI_PTR(g_network_activations_map[0] + 0);
    nl_70_0_conversion_output_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 106, params)) {
    ...
    conv2d_2_bias_array.data = AI_PTR(g_network_weights_map[1] + 0);
    conv2d_2_bias_array.data_start = AI_PTR(g_network_weights_map[1] + 0);
    
    conv2d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_weights_array.data = AI_PTR(g_network_weights_map[2] + 0);
    conv2d_3_weights_array.data_start = AI_PTR(g_network_weights_map[2] + 0);
    
    conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_3_bias_array.data = AI_PTR(g_network_weights_map[3] + 0);
    conv2d_3_bias_array.data_start = AI_PTR(g_network_weights_map[3] + 0);
    
    conv2d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_weights_array.data = AI_PTR(g_network_weights_map[4] + 0);
    conv2d_4_weights_array.data_start = AI_PTR(g_network_weights_map[4] + 0);
    
    conv2d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_4_bias_array.data = AI_PTR(g_network_weights_map[5] + 0);
    conv2d_4_bias_array.data_start = AI_PTR(g_network_weights_map[5] + 0);
    
    conv2d_5_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_weights_array.data = AI_PTR(g_network_weights_map[6] + 0);
    conv2d_5_weights_array.data_start = AI_PTR(g_network_weights_map[6] + 0);
    
    conv2d_5_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_5_bias_array.data = AI_PTR(g_network_weights_map[7] + 0);
    conv2d_5_bias_array.data_start = AI_PTR(g_network_weights_map[7] + 0);
    
    conv2d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_weights_array.data = AI_PTR(g_network_weights_map[8] + 0);
    conv2d_7_weights_array.data_start = AI_PTR(g_network_weights_map[8] + 0);
    
    conv2d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_7_bias_array.data = AI_PTR(g_network_weights_map[9] + 0);
    conv2d_7_bias_array.data_start = AI_PTR(g_network_weights_map[9] + 0);
    
    conv2d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_weights_array.data = AI_PTR(g_network_weights_map[10] + 0);
    conv2d_8_weights_array.data_start = AI_PTR(g_network_weights_map[10] + 0);
    
    conv2d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_8_bias_array.data = AI_PTR(g_network_weights_map[11] + 0);
    conv2d_8_bias_array.data_start = AI_PTR(g_network_weights_map[11] + 0);
    
    conv2d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_weights_array.data = AI_PTR(g_network_weights_map[12] + 0);
    conv2d_9_weights_array.data_start = AI_PTR(g_network_weights_map[12] + 0);
    
    conv2d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_9_bias_array.data = AI_PTR(g_network_weights_map[13] + 0);
    conv2d_9_bias_array.data_start = AI_PTR(g_network_weights_map[13] + 0);
    
    conv2d_10_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_weights_array.data = AI_PTR(g_network_weights_map[14] + 0);
    conv2d_10_weights_array.data_start = AI_PTR(g_network_weights_map[14] + 0);
    
    conv2d_10_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_10_bias_array.data = AI_PTR(g_network_weights_map[15] + 0);
    conv2d_10_bias_array.data_start = AI_PTR(g_network_weights_map[15] + 0);
    
    conv2d_11_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_11_weights_array.data = AI_PTR(g_network_weights_map[16] + 0);
    conv2d_11_weights_array.data_start = AI_PTR(g_network_weights_map[16] + 0);
    
    conv2d_11_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_11_bias_array.data = AI_PTR(g_network_weights_map[17] + 0);
    conv2d_11_bias_array.data_start = AI_PTR(g_network_weights_map[17] + 0);
    
    conv2d_13_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_13_weights_array.data = AI_PTR(g_network_weights_map[18] + 0);
    conv2d_13_weights_array.data_start = AI_PTR(g_network_weights_map[18] + 0);
    
    conv2d_13_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_13_bias_array.data = AI_PTR(g_network_weights_map[19] + 0);
    conv2d_13_bias_array.data_start = AI_PTR(g_network_weights_map[19] + 0);
    
    conv2d_15_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_15_weights_array.data = AI_PTR(g_network_weights_map[20] + 0);
    conv2d_15_weights_array.data_start = AI_PTR(g_network_weights_map[20] + 0);
    
    conv2d_15_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_15_bias_array.data = AI_PTR(g_network_weights_map[21] + 0);
    conv2d_15_bias_array.data_start = AI_PTR(g_network_weights_map[21] + 0);
    
    conv2d_16_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_16_weights_array.data = AI_PTR(g_network_weights_map[22] + 0);
    conv2d_16_weights_array.data_start = AI_PTR(g_network_weights_map[22] + 0);
    
    conv2d_16_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_16_bias_array.data = AI_PTR(g_network_weights_map[23] + 0);
    conv2d_16_bias_array.data_start = AI_PTR(g_network_weights_map[23] + 0);
    
    conv2d_17_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_17_weights_array.data = AI_PTR(g_network_weights_map[24] + 0);
    conv2d_17_weights_array.data_start = AI_PTR(g_network_weights_map[24] + 0);
    
    conv2d_17_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_17_bias_array.data = AI_PTR(g_network_weights_map[25] + 0);
    conv2d_17_bias_array.data_start = AI_PTR(g_network_weights_map[25] + 0);
    
    conv2d_18_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_18_weights_array.data = AI_PTR(g_network_weights_map[26] + 0);
    conv2d_18_weights_array.data_start = AI_PTR(g_network_weights_map[26] + 0);
    
    conv2d_18_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_18_bias_array.data = AI_PTR(g_network_weights_map[27] + 0);
    conv2d_18_bias_array.data_start = AI_PTR(g_network_weights_map[27] + 0);
    
    conv2d_19_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_19_weights_array.data = AI_PTR(g_network_weights_map[28] + 0);
    conv2d_19_weights_array.data_start = AI_PTR(g_network_weights_map[28] + 0);
    
    conv2d_19_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_19_bias_array.data = AI_PTR(g_network_weights_map[29] + 0);
    conv2d_19_bias_array.data_start = AI_PTR(g_network_weights_map[29] + 0);
    
    conv2d_21_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_21_weights_array.data = AI_PTR(g_network_weights_map[30] + 0);
    conv2d_21_weights_array.data_start = AI_PTR(g_network_weights_map[30] + 0);
    
    conv2d_21_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_21_bias_array.data = AI_PTR(g_network_weights_map[31] + 0);
    conv2d_21_bias_array.data_start = AI_PTR(g_network_weights_map[31] + 0);
    
    conv2d_22_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_22_weights_array.data = AI_PTR(g_network_weights_map[32] + 0);
    conv2d_22_weights_array.data_start = AI_PTR(g_network_weights_map[32] + 0);
    
    conv2d_22_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_22_bias_array.data = AI_PTR(g_network_weights_map[33] + 0);
    conv2d_22_bias_array.data_start = AI_PTR(g_network_weights_map[33] + 0);
    
    conv2d_23_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_23_weights_array.data = AI_PTR(g_network_weights_map[34] + 0);
    conv2d_23_weights_array.data_start = AI_PTR(g_network_weights_map[34] + 0);
    
    conv2d_23_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_23_bias_array.data = AI_PTR(g_network_weights_map[35] + 0);
    conv2d_23_bias_array.data_start = AI_PTR(g_network_weights_map[35] + 0);
    
    conv2d_25_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_25_weights_array.data = AI_PTR(g_network_weights_map[36] + 0);
    conv2d_25_weights_array.data_start = AI_PTR(g_network_weights_map[36] + 0);
    
    conv2d_25_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_25_bias_array.data = AI_PTR(g_network_weights_map[37] + 0);
    conv2d_25_bias_array.data_start = AI_PTR(g_network_weights_map[37] + 0);
    
    conv2d_27_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_27_weights_array.data = AI_PTR(g_network_weights_map[38] + 0);
    conv2d_27_weights_array.data_start = AI_PTR(g_network_weights_map[38] + 0);
    
    conv2d_27_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_27_bias_array.data = AI_PTR(g_network_weights_map[39] + 0);
    conv2d_27_bias_array.data_start = AI_PTR(g_network_weights_map[39] + 0);
    
    conv2d_28_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_28_weights_array.data = AI_PTR(g_network_weights_map[40] + 0);
    conv2d_28_weights_array.data_start = AI_PTR(g_network_weights_map[40] + 0);
    
    conv2d_28_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_28_bias_array.data = AI_PTR(g_network_weights_map[41] + 0);
    conv2d_28_bias_array.data_start = AI_PTR(g_network_weights_map[41] + 0);
    
    conv2d_29_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_29_weights_array.data = AI_PTR(g_network_weights_map[42] + 0);
    conv2d_29_weights_array.data_start = AI_PTR(g_network_weights_map[42] + 0);
    
    conv2d_29_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_29_bias_array.data = AI_PTR(g_network_weights_map[43] + 0);
    conv2d_29_bias_array.data_start = AI_PTR(g_network_weights_map[43] + 0);
    
    conv2d_30_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_30_weights_array.data = AI_PTR(g_network_weights_map[44] + 0);
    conv2d_30_weights_array.data_start = AI_PTR(g_network_weights_map[44] + 0);
    
    conv2d_30_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_30_bias_array.data = AI_PTR(g_network_weights_map[45] + 0);
    conv2d_30_bias_array.data_start = AI_PTR(g_network_weights_map[45] + 0);
    
    conv2d_31_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_31_weights_array.data = AI_PTR(g_network_weights_map[46] + 0);
    conv2d_31_weights_array.data_start = AI_PTR(g_network_weights_map[46] + 0);
    
    conv2d_31_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_31_bias_array.data = AI_PTR(g_network_weights_map[47] + 0);
    conv2d_31_bias_array.data_start = AI_PTR(g_network_weights_map[47] + 0);
    
    conv2d_33_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_33_weights_array.data = AI_PTR(g_network_weights_map[48] + 0);
    conv2d_33_weights_array.data_start = AI_PTR(g_network_weights_map[48] + 0);
    
    conv2d_33_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_33_bias_array.data = AI_PTR(g_network_weights_map[49] + 0);
    conv2d_33_bias_array.data_start = AI_PTR(g_network_weights_map[49] + 0);
    
    conv2d_34_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_34_weights_array.data = AI_PTR(g_network_weights_map[50] + 0);
    conv2d_34_weights_array.data_start = AI_PTR(g_network_weights_map[50] + 0);
    
    conv2d_34_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_34_bias_array.data = AI_PTR(g_network_weights_map[51] + 0);
    conv2d_34_bias_array.data_start = AI_PTR(g_network_weights_map[51] + 0);
    
    conv2d_35_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_35_weights_array.data = AI_PTR(g_network_weights_map[52] + 0);
    conv2d_35_weights_array.data_start = AI_PTR(g_network_weights_map[52] + 0);
    
    conv2d_35_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_35_bias_array.data = AI_PTR(g_network_weights_map[53] + 0);
    conv2d_35_bias_array.data_start = AI_PTR(g_network_weights_map[53] + 0);
    
    conv2d_37_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_37_weights_array.data = AI_PTR(g_network_weights_map[54] + 0);
    conv2d_37_weights_array.data_start = AI_PTR(g_network_weights_map[54] + 0);
    
    conv2d_37_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_37_bias_array.data = AI_PTR(g_network_weights_map[55] + 0);
    conv2d_37_bias_array.data_start = AI_PTR(g_network_weights_map[55] + 0);
    
    conv2d_38_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_38_weights_array.data = AI_PTR(g_network_weights_map[56] + 0);
    conv2d_38_weights_array.data_start = AI_PTR(g_network_weights_map[56] + 0);
    
    conv2d_38_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_38_bias_array.data = AI_PTR(g_network_weights_map[57] + 0);
    conv2d_38_bias_array.data_start = AI_PTR(g_network_weights_map[57] + 0);
    
    conv2d_39_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_39_weights_array.data = AI_PTR(g_network_weights_map[58] + 0);
    conv2d_39_weights_array.data_start = AI_PTR(g_network_weights_map[58] + 0);
    
    conv2d_39_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_39_bias_array.data = AI_PTR(g_network_weights_map[59] + 0);
    conv2d_39_bias_array.data_start = AI_PTR(g_network_weights_map[59] + 0);
    
    conv2d_41_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_41_weights_array.data = AI_PTR(g_network_weights_map[60] + 0);
    conv2d_41_weights_array.data_start = AI_PTR(g_network_weights_map[60] + 0);
    
    conv2d_41_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_41_bias_array.data = AI_PTR(g_network_weights_map[61] + 0);
    conv2d_41_bias_array.data_start = AI_PTR(g_network_weights_map[61] + 0);
    
    conv2d_42_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_42_weights_array.data = AI_PTR(g_network_weights_map[62] + 0);
    conv2d_42_weights_array.data_start = AI_PTR(g_network_weights_map[62] + 0);
    
    conv2d_42_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_42_bias_array.data = AI_PTR(g_network_weights_map[63] + 0);
    conv2d_42_bias_array.data_start = AI_PTR(g_network_weights_map[63] + 0);
    
    conv2d_43_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_43_weights_array.data = AI_PTR(g_network_weights_map[64] + 0);
    conv2d_43_weights_array.data_start = AI_PTR(g_network_weights_map[64] + 0);
    
    conv2d_43_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_43_bias_array.data = AI_PTR(g_network_weights_map[65] + 0);
    conv2d_43_bias_array.data_start = AI_PTR(g_network_weights_map[65] + 0);
    
    conv2d_44_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_44_weights_array.data = AI_PTR(g_network_weights_map[66] + 0);
    conv2d_44_weights_array.data_start = AI_PTR(g_network_weights_map[66] + 0);
    
    conv2d_44_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_44_bias_array.data = AI_PTR(g_network_weights_map[67] + 0);
    conv2d_44_bias_array.data_start = AI_PTR(g_network_weights_map[67] + 0);
    
    conv2d_45_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_45_weights_array.data = AI_PTR(g_network_weights_map[68] + 0);
    conv2d_45_weights_array.data_start = AI_PTR(g_network_weights_map[68] + 0);
    
    conv2d_45_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_45_bias_array.data = AI_PTR(g_network_weights_map[69] + 0);
    conv2d_45_bias_array.data_start = AI_PTR(g_network_weights_map[69] + 0);
    
    conv2d_46_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_46_weights_array.data = AI_PTR(g_network_weights_map[70] + 0);
    conv2d_46_weights_array.data_start = AI_PTR(g_network_weights_map[70] + 0);
    
    conv2d_46_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_46_bias_array.data = AI_PTR(g_network_weights_map[71] + 0);
    conv2d_46_bias_array.data_start = AI_PTR(g_network_weights_map[71] + 0);
    
    conv2d_48_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_48_weights_array.data = AI_PTR(g_network_weights_map[72] + 0);
    conv2d_48_weights_array.data_start = AI_PTR(g_network_weights_map[72] + 0);
    
    conv2d_48_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_48_bias_array.data = AI_PTR(g_network_weights_map[73] + 0);
    conv2d_48_bias_array.data_start = AI_PTR(g_network_weights_map[73] + 0);
    
    conv2d_49_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_49_weights_array.data = AI_PTR(g_network_weights_map[74] + 0);
    conv2d_49_weights_array.data_start = AI_PTR(g_network_weights_map[74] + 0);
    
    conv2d_49_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_49_bias_array.data = AI_PTR(g_network_weights_map[75] + 0);
    conv2d_49_bias_array.data_start = AI_PTR(g_network_weights_map[75] + 0);
    
    conv2d_50_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_50_weights_array.data = AI_PTR(g_network_weights_map[76] + 0);
    conv2d_50_weights_array.data_start = AI_PTR(g_network_weights_map[76] + 0);
    
    conv2d_50_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_50_bias_array.data = AI_PTR(g_network_weights_map[77] + 0);
    conv2d_50_bias_array.data_start = AI_PTR(g_network_weights_map[77] + 0);
    
    conv2d_52_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_52_weights_array.data = AI_PTR(g_network_weights_map[78] + 0);
    conv2d_52_weights_array.data_start = AI_PTR(g_network_weights_map[78] + 0);
    
    conv2d_52_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_52_bias_array.data = AI_PTR(g_network_weights_map[79] + 0);
    conv2d_52_bias_array.data_start = AI_PTR(g_network_weights_map[79] + 0);
    
    conv2d_54_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_54_weights_array.data = AI_PTR(g_network_weights_map[80] + 0);
    conv2d_54_weights_array.data_start = AI_PTR(g_network_weights_map[80] + 0);
    
    conv2d_54_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_54_bias_array.data = AI_PTR(g_network_weights_map[81] + 0);
    conv2d_54_bias_array.data_start = AI_PTR(g_network_weights_map[81] + 0);
    
    conv2d_55_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_55_weights_array.data = AI_PTR(g_network_weights_map[82] + 0);
    conv2d_55_weights_array.data_start = AI_PTR(g_network_weights_map[82] + 0);
    
    conv2d_55_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_55_bias_array.data = AI_PTR(g_network_weights_map[83] + 0);
    conv2d_55_bias_array.data_start = AI_PTR(g_network_weights_map[83] + 0);
    
    conv2d_56_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_56_weights_array.data = AI_PTR(g_network_weights_map[84] + 0);
    conv2d_56_weights_array.data_start = AI_PTR(g_network_weights_map[84] + 0);
    
    conv2d_56_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_56_bias_array.data = AI_PTR(g_network_weights_map[85] + 0);
    conv2d_56_bias_array.data_start = AI_PTR(g_network_weights_map[85] + 0);
    
    conv2d_57_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_57_weights_array.data = AI_PTR(g_network_weights_map[86] + 0);
    conv2d_57_weights_array.data_start = AI_PTR(g_network_weights_map[86] + 0);
    
    conv2d_57_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_57_bias_array.data = AI_PTR(g_network_weights_map[87] + 0);
    conv2d_57_bias_array.data_start = AI_PTR(g_network_weights_map[87] + 0);
    
    conv2d_58_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_58_weights_array.data = AI_PTR(g_network_weights_map[88] + 0);
    conv2d_58_weights_array.data_start = AI_PTR(g_network_weights_map[88] + 0);
    
    conv2d_58_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_58_bias_array.data = AI_PTR(g_network_weights_map[89] + 0);
    conv2d_58_bias_array.data_start = AI_PTR(g_network_weights_map[89] + 0);
    
    conv2d_60_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_60_weights_array.data = AI_PTR(g_network_weights_map[90] + 0);
    conv2d_60_weights_array.data_start = AI_PTR(g_network_weights_map[90] + 0);
    
    conv2d_60_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_60_bias_array.data = AI_PTR(g_network_weights_map[91] + 0);
    conv2d_60_bias_array.data_start = AI_PTR(g_network_weights_map[91] + 0);
    
    conv2d_61_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_61_weights_array.data = AI_PTR(g_network_weights_map[92] + 0);
    conv2d_61_weights_array.data_start = AI_PTR(g_network_weights_map[92] + 0);
    
    conv2d_61_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_61_bias_array.data = AI_PTR(g_network_weights_map[93] + 0);
    conv2d_61_bias_array.data_start = AI_PTR(g_network_weights_map[93] + 0);
    
    conv2d_62_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_62_weights_array.data = AI_PTR(g_network_weights_map[94] + 0);
    conv2d_62_weights_array.data_start = AI_PTR(g_network_weights_map[94] + 0);
    
    conv2d_62_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_62_bias_array.data = AI_PTR(g_network_weights_map[95] + 0);
    conv2d_62_bias_array.data_start = AI_PTR(g_network_weights_map[95] + 0);
    
    conv2d_64_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_64_weights_array.data = AI_PTR(g_network_weights_map[96] + 0);
    conv2d_64_weights_array.data_start = AI_PTR(g_network_weights_map[96] + 0);
    
    conv2d_64_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_64_bias_array.data = AI_PTR(g_network_weights_map[97] + 0);
    conv2d_64_bias_array.data_start = AI_PTR(g_network_weights_map[97] + 0);
    
    conv2d_65_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_65_weights_array.data = AI_PTR(g_network_weights_map[98] + 0);
    conv2d_65_weights_array.data_start = AI_PTR(g_network_weights_map[98] + 0);
    
    conv2d_65_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_65_bias_array.data = AI_PTR(g_network_weights_map[99] + 0);
    conv2d_65_bias_array.data_start = AI_PTR(g_network_weights_map[99] + 0);
    
    conv2d_66_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_66_weights_array.data = AI_PTR(g_network_weights_map[100] + 0);
    conv2d_66_weights_array.data_start = AI_PTR(g_network_weights_map[100] + 0);
    
    conv2d_66_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_66_bias_array.data = AI_PTR(g_network_weights_map[101] + 0);
    conv2d_66_bias_array.data_start = AI_PTR(g_network_weights_map[101] + 0);
    
    conv2d_67_weights_array.format |= AI_FMT_FLAG_CONST;
    conv2d_67_weights_array.data = AI_PTR(g_network_weights_map[102] + 0);
    conv2d_67_weights_array.data_start = AI_PTR(g_network_weights_map[102] + 0);
    
    conv2d_67_bias_array.format |= AI_FMT_FLAG_CONST;
    conv2d_67_bias_array.data = AI_PTR(g_network_weights_map[103] + 0);
    conv2d_67_bias_array.data_start = AI_PTR(g_network_weights_map[103] + 0);
    
    dense_69_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_69_weights_array.data = AI_PTR(g_network_weights_map[104] + 0);
    dense_69_weights_array.data_start = AI_PTR(g_network_weights_map[104] + 0);
    
    dense_69_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_69_bias_array.data = AI_PTR(g_network_weights_map[105] + 0);
    dense_69_bias_array.data_start = AI_PTR(g_network_weights_map[105] + 0);
